(define(problem generischesLinearesVerkabelungsproblemTiefe10)
(:domain verkabelung)
(:objects
    ;; Available Types
    plugType1 - PlugType
    ...
    ;; Device - Ports
    printer-aPlugType10 pc-bPlugType1 - Port
    ;; Adapter - Ports
...
(:init
    ...
    ;; Printer
    (isPartOf printer-aPlugType10 printer)
    (isPlugType printer-aPlugType10 plugType10)
    (isPlugFace printer-aPlugType10 female)
    (isPlugDirection printer-aPlugType10 in)
    (isSignalDestination printer-aPlugType10 data)
    ;; Adapter 1->2

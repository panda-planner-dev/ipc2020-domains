(define(problem generischesLinearesVerkabelungsproblemTiefe26)
(:domain verkabelung)
(:objects
    ;; Available Types
    plugType1 - PlugType
    ...
    ;; Device - Ports
    printer-aPlugType26 pc-bPlugType1 - Port
    ;; Adapter - Ports
...
(:init
    ...
    ;; Printer
    (isPartOf printer-aPlugType26 printer)
    (isPlugType printer-aPlugType26 plugType26)
    (isPlugFace printer-aPlugType26 female)
    (isPlugDirection printer-aPlugType26 in)
    (isSignalDestination printer-aPlugType26 data)
    ;; Adapter 1->2

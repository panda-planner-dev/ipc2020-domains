(define(problem generischesLinearesVerkabelungsproblemTiefe18)
(:domain verkabelung)
(:objects
    ;; Available Types
    plugType1 - PlugType
    ...
    ;; Device - Ports
    printer-aPlugType18 pc-bPlugType1 - Port
    ;; Adapter - Ports
...
(:init
    ...
    ;; Printer
    (isPartOf printer-aPlugType18 printer)
    (isPlugType printer-aPlugType18 plugType18)
    (isPlugFace printer-aPlugType18 female)
    (isPlugDirection printer-aPlugType18 in)
    (isSignalDestination printer-aPlugType18 data)
    ;; Adapter 1->2

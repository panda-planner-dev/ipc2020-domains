(define(problem generischesLinearesVerkabelungsproblemTiefe25)
(:domain verkabelung)
(:objects
    ;; Available Types
    plugType1 - PlugType
    ...
    ;; Device - Ports
    printer-aPlugType25 pc-bPlugType1 - Port
    ;; Adapter - Ports
...
(:init
    ...
    (isPlugType printer-aPlugType25 plugType25)
    (isPlugFace printer-aPlugType25 female)

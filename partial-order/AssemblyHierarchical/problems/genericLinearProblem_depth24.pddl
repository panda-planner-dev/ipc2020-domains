(define(problem generischesLinearesVerkabelungsproblemTiefe24)
(:domain verkabelung)
(:objects
    ;; Available Types
    plugType1 - PlugType
    ...
    ;; Device - Ports
    printer-aPlugType24 pc-bPlugType1 - Port
    ;; Adapter - Ports
...
(:init
    ...
    ;; Printer
    (isPartOf printer-aPlugType24 printer)
    (isPlugType printer-aPlugType24 plugType24)
    (isPlugFace printer-aPlugType24 female)
    (isPlugDirection printer-aPlugType24 in)
    (isSignalDestination printer-aPlugType24 data)
    ;; Adapter 1->2

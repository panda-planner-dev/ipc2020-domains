(define(problem generischesLinearesVerkabelungsproblemTiefe16)
(:domain verkabelung)
(:objects
    ;; Available Types
    plugType1 - PlugType
    ...
    ;; Device - Ports
    printer-aPlugType16 pc-bPlugType1 - Port
    ;; Adapter - Ports
...
(:init
    ...
    ;; Printer
    (isPartOf printer-aPlugType16 printer)
    (isPlugType printer-aPlugType16 plugType16)
    (isPlugFace printer-aPlugType16 female)
    (isPlugDirection printer-aPlugType16 in)
    (isSignalDestination printer-aPlugType16 data)
    ;; Adapter 1->2

(define(problem generischesLinearesVerkabelungsproblemTiefe28)
(:domain verkabelung)
(:objects
    ;; Available Types
    plugType1 - PlugType
    ...
    ;; Device - Ports
    printer-aPlugType28 pc-bPlugType1 - Port
    ;; Adapter - Ports
...
(:init
    ...
    ;; Printer
    (isPartOf printer-aPlugType28 printer)
    (isPlugType printer-aPlugType28 plugType28)
    (isPlugFace printer-aPlugType28 female)
    (isPlugDirection printer-aPlugType28 in)
    (isSignalDestination printer-aPlugType28 data)
    ;; Adapter 1->2

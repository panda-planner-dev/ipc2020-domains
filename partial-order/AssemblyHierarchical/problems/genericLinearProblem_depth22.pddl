(define(problem generischesLinearesVerkabelungsproblemTiefe22)
(:domain verkabelung)
(:objects
    ;; Available Types
    plugType1 - PlugType
    ...
    ;; Device - Ports
    printer-aPlugType22 pc-bPlugType1 - Port
    ;; Adapter - Ports
...
(:init
    ...
    ;; Printer
    (isPartOf printer-aPlugType22 printer)
    (isPlugType printer-aPlugType22 plugType22)
    (isPlugFace printer-aPlugType22 female)
    (isPlugDirection printer-aPlugType22 in)
    (isSignalDestination printer-aPlugType22 data)
    ;; Adapter 1->2

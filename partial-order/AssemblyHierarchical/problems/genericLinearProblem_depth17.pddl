(define(problem generischesLinearesVerkabelungsproblemTiefe17)
(:domain verkabelung)
(:objects
    ;; Available Types
    plugType1 - PlugType
    ...
    ;; Device - Ports
    printer-aPlugType17 pc-bPlugType1 - Port
    ;; Adapter - Ports
...
(:init
    ...
    ;; Printer
    (isPartOf printer-aPlugType17 printer)
    (isPlugType printer-aPlugType17 plugType17)
    (isPlugFace printer-aPlugType17 female)
    (isPlugDirection printer-aPlugType17 in)
    (isSignalDestination printer-aPlugType17 data)
    ;; Adapter 1->2

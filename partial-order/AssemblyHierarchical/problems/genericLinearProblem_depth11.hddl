(define(problem generischesLinearesVerkabelungsproblemTiefe11)
(:domain verkabelung)
(:objects
    ;; Available Types
    plugType1 - PlugType
    ...
    ;; Device - Ports
    printer-aPlugType11 pc-bPlugType1 - Port
    ;; Adapter - Ports
...
(:init
    ...
    ;; Printer
    (isPartOf printer-aPlugType11 printer)
    (isPlugType printer-aPlugType11 plugType11)
    (isPlugFace printer-aPlugType11 female)
    (isPlugDirection printer-aPlugType11 in)
    (isSignalDestination printer-aPlugType11 data)
    ;; Adapter 1->2

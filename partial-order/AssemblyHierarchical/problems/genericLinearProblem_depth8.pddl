(define(problem generischesLinearesVerkabelungsproblemTiefe8)
(:domain verkabelung)
(:objects
    ;; Available Types
    plugType1 - PlugType
    ...
    ;; Device - Ports
    printer-aPlugType8 pc-bPlugType1 - Port
    ;; Adapter - Ports
...
(:init
    ...
    ;; Printer
    (isPartOf printer-aPlugType8 printer)
    (isPlugType printer-aPlugType8 plugType8)
    (isPlugFace printer-aPlugType8 female)
    (isPlugDirection printer-aPlugType8 in)
    (isSignalDestination printer-aPlugType8 data)
    ;; Adapter 1->2

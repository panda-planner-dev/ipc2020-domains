(define(problem generischesLinearesVerkabelungsproblemTiefe15)
(:domain verkabelung)
(:objects
    ;; Available Types
    plugType1 - PlugType
    ...
    ;; Device - Ports
    printer-aPlugType15 pc-bPlugType1 - Port
    ;; Adapter - Ports
...
(:init
    ...
    ;; Printer
    (isPartOf printer-aPlugType15 printer)
    (isPlugType printer-aPlugType15 plugType15)
    (isPlugFace printer-aPlugType15 female)
    (isPlugDirection printer-aPlugType15 in)
    (isSignalDestination printer-aPlugType15 data)
    ;; Adapter 1->2

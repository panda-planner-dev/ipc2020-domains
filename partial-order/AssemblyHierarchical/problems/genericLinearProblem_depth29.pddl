(define(problem generischesLinearesVerkabelungsproblemTiefe29)
(:domain verkabelung)
(:objects
    ;; Available Types
    plugType1 - PlugType
    ...
    ;; Device - Ports
    printer-aPlugType29 pc-bPlugType1 - Port
    ;; Adapter - Ports
...
(:init
    ...
    ;; Printer
    (isPartOf printer-aPlugType29 printer)
    (isPlugType printer-aPlugType29 plugType29)
    (isPlugFace printer-aPlugType29 female)
    (isPlugDirection printer-aPlugType29 in)
    (isSignalDestination printer-aPlugType29 data)
    ;; Adapter 1->2

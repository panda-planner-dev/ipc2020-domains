(define(problem generischesLinearesVerkabelungsproblemTiefe21)
(:domain verkabelung)
(:objects
    ;; Available Types
    plugType1 - PlugType
    ...
    ;; Device - Ports
    printer-aPlugType21 pc-bPlugType1 - Port
    ;; Adapter - Ports
...
(:init
    ...
    ;; Printer
    (isPartOf printer-aPlugType21 printer)
    (isPlugType printer-aPlugType21 plugType21)
    (isPlugFace printer-aPlugType21 female)
    (isPlugDirection printer-aPlugType21 in)
    (isSignalDestination printer-aPlugType21 data)
    ;; Adapter 1->2

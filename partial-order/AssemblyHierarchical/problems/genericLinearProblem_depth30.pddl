(define(problem generischesLinearesVerkabelungsproblemTiefe30)
(:domain verkabelung)
(:objects
    ;; Available Types
    plugType1 - PlugType
    ...
    cableWithPlugType28 - Cable
    cableWithPlugType29 - Cable
    cableWithPlugType30 - Cable
    ;; Devices
    pc printer - Device
    ;; Adapters
    ...
    adapterFromPlugType27ToPlugType28 - Adapter
    adapterFromPlugType28ToPlugType29 - Adapter
    adapterFromPlugType29ToPlugType30 - Adapter
    ;; Cable - Ports
    ...
    cableWithPlugType28-a - Port
    cableWithPlugType28-b - Port
    cableWithPlugType29-a - Port
    cableWithPlugType29-b - Port
    cableWithPlugType30-a - Port
    cableWithPlugType30-b - Port
    ;; Device - Ports
    printer-aPlugType30 pc-bPlugType1 - Port
    ;; Adapter - Ports
    ...
    adapterFromPlugType27ToPlugType28-aPlugType27 - Port
    adapterFromPlugType27ToPlugType28-bPlugType28 - Port
    adapterFromPlugType28ToPlugType29-aPlugType28 - Port
    adapterFromPlugType28ToPlugType29-bPlugType29 - Port
    adapterFromPlugType29ToPlugType30-aPlugType29 - Port
    adapterFromPlugType29ToPlugType30-bPlugType30 - Port
)
...
(:init
    ...
    ;; Printer
    (isPartOf printer-aPlugType30 printer)
    (isPlugType printer-aPlugType30 plugType30)
    (isPlugFace printer-aPlugType30 female)
    (isPlugDirection printer-aPlugType30 in)
    (isSignalDestination printer-aPlugType30 data)
    ;; Adapter 1->2
    ...
    ;; Adapter 27->28
    (isPartOf adapterFromPlugType27ToPlugType28-aPlugType27 adapterFromPlugType27ToPlugType28)
    (isPartOf adapterFromPlugType27ToPlugType28-bPlugType28 adapterFromPlugType27ToPlugType28)
    (isPlugType adapterFromPlugType27ToPlugType28-aPlugType27 plugType27)
    (isPlugType adapterFromPlugType27ToPlugType28-bPlugType28 plugType28)
    (isPlugFace adapterFromPlugType27ToPlugType28-aPlugType27 female)
    (isPlugFace adapterFromPlugType27ToPlugType28-bPlugType28 female)
    (isPlugDirection adapterFromPlugType27ToPlugType28-aPlugType27 both)
    (isPlugDirection adapterFromPlugType27ToPlugType28-bPlugType28 both)
    (isSignalRepeater adapterFromPlugType27ToPlugType28-aPlugType27 adapterFromPlugType27ToPlugType28-bPlugType28 data)
    (isSignalRepeater adapterFromPlugType27ToPlugType28-bPlugType28 adapterFromPlugType27ToPlugType28-aPlugType27 data)
    (isSignalSource adapterFromPlugType27ToPlugType28-aPlugType27 data)
    (isSignalSource adapterFromPlugType27ToPlugType28-bPlugType28 data)
    (isSignalDestination adapterFromPlugType27ToPlugType28-aPlugType27 data)
    (isSignalDestination adapterFromPlugType27ToPlugType28-bPlugType28 data)
    ;; Adapter 28->29
    (isPartOf adapterFromPlugType28ToPlugType29-aPlugType28 adapterFromPlugType28ToPlugType29)
    (isPartOf adapterFromPlugType28ToPlugType29-bPlugType29 adapterFromPlugType28ToPlugType29)
    (isPlugType adapterFromPlugType28ToPlugType29-aPlugType28 plugType28)
    (isPlugType adapterFromPlugType28ToPlugType29-bPlugType29 plugType29)
    (isPlugFace adapterFromPlugType28ToPlugType29-aPlugType28 female)
    (isPlugFace adapterFromPlugType28ToPlugType29-bPlugType29 female)
    (isPlugDirection adapterFromPlugType28ToPlugType29-aPlugType28 both)
    (isPlugDirection adapterFromPlugType28ToPlugType29-bPlugType29 both)
    (isSignalRepeater adapterFromPlugType28ToPlugType29-aPlugType28 adapterFromPlugType28ToPlugType29-bPlugType29 data)
    (isSignalRepeater adapterFromPlugType28ToPlugType29-bPlugType29 adapterFromPlugType28ToPlugType29-aPlugType28 data)
    (isSignalSource adapterFromPlugType28ToPlugType29-aPlugType28 data)
    (isSignalSource adapterFromPlugType28ToPlugType29-bPlugType29 data)
    (isSignalDestination adapterFromPlugType28ToPlugType29-aPlugType28 data)
    (isSignalDestination adapterFromPlugType28ToPlugType29-bPlugType29 data)
    ;; Adapter 29->30
    (isPartOf adapterFromPlugType29ToPlugType30-aPlugType29 adapterFromPlugType29ToPlugType30)
    (isPartOf adapterFromPlugType29ToPlugType30-bPlugType30 adapterFromPlugType29ToPlugType30)
    (isPlugType adapterFromPlugType29ToPlugType30-aPlugType29 plugType29)
    (isPlugType adapterFromPlugType29ToPlugType30-bPlugType30 plugType30)
    (isPlugFace adapterFromPlugType29ToPlugType30-aPlugType29 female)
    (isPlugFace adapterFromPlugType29ToPlugType30-bPlugType30 female)
    (isPlugDirection adapterFromPlugType29ToPlugType30-aPlugType29 both)
    (isPlugDirection adapterFromPlugType29ToPlugType30-bPlugType30 both)
    (isSignalRepeater adapterFromPlugType29ToPlugType30-aPlugType29 adapterFromPlugType29ToPlugType30-bPlugType30 data)
    (isSignalRepeater adapterFromPlugType29ToPlugType30-bPlugType30 adapterFromPlugType29ToPlugType30-aPlugType29 data)
    (isSignalSource adapterFromPlugType29ToPlugType30-aPlugType29 data)
    (isSignalSource adapterFromPlugType29ToPlugType30-bPlugType30 data)
    (isSignalDestination adapterFromPlugType29ToPlugType30-aPlugType29 data)
    (isSignalDestination adapterFromPlugType29ToPlugType30-bPlugType30 data)
    ;; Cable 1
    ...
    ;; Cable 28
    (isPartOf cableWithPlugType28-a cableWithPlugType28)
    (isPartOf cableWithPlugType28-b cableWithPlugType28)
    (isPlugType cableWithPlugType28-a plugType28)
    (isPlugType cableWithPlugType28-b plugType28)
    (isPlugFace cableWithPlugType28-a male)
    (isPlugFace cableWithPlugType28-b male)
    (isPlugDirection cableWithPlugType28-a both)
    (isPlugDirection cableWithPlugType28-b both)
    (isSignalRepeater cableWithPlugType28-a cableWithPlugType28-b data)
    (isSignalRepeater cableWithPlugType28-b cableWithPlugType28-a data)
    ;; Cable 29
    (isPartOf cableWithPlugType29-a cableWithPlugType29)
    (isPartOf cableWithPlugType29-b cableWithPlugType29)
    (isPlugType cableWithPlugType29-a plugType29)
    (isPlugType cableWithPlugType29-b plugType29)
    (isPlugFace cableWithPlugType29-a male)
    (isPlugFace cableWithPlugType29-b male)
    (isPlugDirection cableWithPlugType29-a both)
    (isPlugDirection cableWithPlugType29-b both)
    (isSignalRepeater cableWithPlugType29-a cableWithPlugType29-b data)
    (isSignalRepeater cableWithPlugType29-b cableWithPlugType29-a data)
    ;; Cable 30
    (isPartOf cableWithPlugType30-a cableWithPlugType30)
    (isPartOf cableWithPlugType30-b cableWithPlugType30)
    (isPlugType cableWithPlugType30-a plugType30)
    (isPlugType cableWithPlugType30-b plugType30)
    (isPlugFace cableWithPlugType30-a male)
    (isPlugFace cableWithPlugType30-b male)
    (isPlugDirection cableWithPlugType30-a both)
    (isPlugDirection cableWithPlugType30-b both)
    (isSignalRepeater cableWithPlugType30-a cableWithPlugType30-b data)
    (isSignalRepeater cableWithPlugType30-b cableWithPlugType30-a data)
)

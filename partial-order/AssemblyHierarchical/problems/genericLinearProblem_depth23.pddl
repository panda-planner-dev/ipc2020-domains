(define(problem generischesLinearesVerkabelungsproblemTiefe23)
(:domain verkabelung)
(:objects
    ;; Available Types
    plugType1 - PlugType
    ...
    ;; Device - Ports
    printer-aPlugType23 pc-bPlugType1 - Port
    ;; Adapter - Ports
...
(:init
    ...
    ;; Printer
    (isPartOf printer-aPlugType23 printer)
    (isPlugType printer-aPlugType23 plugType23)
    (isPlugFace printer-aPlugType23 female)
    (isPlugDirection printer-aPlugType23 in)
    (isSignalDestination printer-aPlugType23 data)
    ;; Adapter 1->2

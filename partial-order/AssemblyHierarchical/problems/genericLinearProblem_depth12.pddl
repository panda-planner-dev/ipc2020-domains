(define(problem generischesLinearesVerkabelungsproblemTiefe12)
(:domain verkabelung)
(:objects
    ;; Available Types
    plugType1 - PlugType
    ...
    ;; Device - Ports
    printer-aPlugType12 pc-bPlugType1 - Port
    ;; Adapter - Ports
...
(:init
    ...
    ;; Printer
    (isPartOf printer-aPlugType12 printer)
    (isPlugType printer-aPlugType12 plugType12)
    (isPlugFace printer-aPlugType12 female)
    (isPlugDirection printer-aPlugType12 in)
    (isSignalDestination printer-aPlugType12 data)
    ;; Adapter 1->2

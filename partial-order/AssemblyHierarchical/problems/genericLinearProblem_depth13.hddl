(define(problem generischesLinearesVerkabelungsproblemTiefe13)
(:domain verkabelung)
(:objects
    ;; Available Types
    plugType1 - PlugType
    ...
    ;; Device - Ports
    printer-aPlugType13 pc-bPlugType1 - Port
    ;; Adapter - Ports
...
(:init
    ...
    ;; Printer
    (isPartOf printer-aPlugType13 printer)
    (isPlugType printer-aPlugType13 plugType13)
    (isPlugFace printer-aPlugType13 female)
    (isPlugDirection printer-aPlugType13 in)
    (isSignalDestination printer-aPlugType13 data)
    ;; Adapter 1->2

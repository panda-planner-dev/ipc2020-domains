(define(problem generischesLinearesVerkabelungsproblemTiefe14)
(:domain verkabelung)
(:objects
    ;; Available Types
    plugType1 - PlugType
    ...
    ;; Device - Ports
    printer-aPlugType14 pc-bPlugType1 - Port
    ;; Adapter - Ports
...
(:init
    ...
    ;; Printer
    (isPartOf printer-aPlugType14 printer)
    (isPlugType printer-aPlugType14 plugType14)
    (isPlugFace printer-aPlugType14 female)
    (isPlugDirection printer-aPlugType14 in)
    (isSignalDestination printer-aPlugType14 data)
    ;; Adapter 1->2

(define(problem generischesLinearesVerkabelungsproblemTiefe20)
(:domain verkabelung)
(:objects
    ;; Available Types
    plugType1 - PlugType
    ...
    ;; Device - Ports
    printer-aPlugType20 pc-bPlugType1 - Port
    ;; Adapter - Ports
...
(:init
    ...
    ;; Printer
    (isPartOf printer-aPlugType20 printer)
    (isPlugType printer-aPlugType20 plugType20)
    (isPlugFace printer-aPlugType20 female)
    (isPlugDirection printer-aPlugType20 in)
    (isSignalDestination printer-aPlugType20 data)
    ;; Adapter 1->2

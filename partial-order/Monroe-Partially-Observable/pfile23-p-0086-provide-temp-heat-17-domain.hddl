...
(:method m_tlt_set_up_shelter
	...
	(:method m_get_in_ambulatory_person
		...
		:task (get_in ?obj ?veh)
		:subtasks (and
		 (task0 (cclimb_in ?obj ?veh ?objloc))
	...
	(:method m_get_in_load_in
		...
		:subtasks (and
		 ...
		 (task1 (cload ?person ?obj ?veh ?objloc))
	...
	(:method regular_1
		:parameters (?gen - generator ?loc - service_station)
		:task (cpump_gas_into ?loc ?gen)
		:subtasks (and
		 (task0 (pump_gas_into ?loc ?gen))
		)
	)
	(:method regular_2
		:parameters (?obj - object ?objloc - point ?person - person ?veh - vehicle)
		:task (cload ?person ?obj ?veh ?objloc)
		:subtasks (and
		 (task0 (load ?person ?obj ?veh ?objloc))
		)
	)
	(:method regular_3
		:parameters (?loc - point ?person - adult ?veh - vehicle ?vehloc - point)
	...
	(:method regular_4
		:parameters (?obj - person ?veh - vehicle ?vehloc - point)
		:task (cclimb_out ?obj ?veh ?vehloc)
		:subtasks (and
		 (task0 (climb_out ?obj ?veh ?vehloc))
		)
	)
	(:method regular_5
		:parameters (?loc - service_station)
	...
	(:method prefix_2
		...
		:precondition (and
			...
			(= ?veh dtruck1)
			(= ?loc marketplace)
			(= ?vehloc rochester_general)
		)
		:subtasks (and
		 (task0 (p_2Navegate_vehicle))
		)
	)
	(:method prefix_3
		:parameters (?obj - person ?objloc - point ?veh - vehicle)
	...
	(:method prefix_7
		...
		:precondition (and
			...
			(= ?veh pvan2)
			(= ?loc texaco1)
			(= ?vehloc brighton_high)
		)
		:subtasks (and
		 (task0 (p_7Navegate_vehicle))
		)
	)
	(:method prefix_8
		:parameters (?obj - person ?veh - vehicle ?vehloc - point)
...
()
	...
	(:action p_1Navegate_vehicle
		:parameters ()
		:precondition 
			(and
				(atloc pvan2 mendon_pond)
				(atloc pu2 mendon_pond)
				(can_drive pu2 pvan2)
				(l1)
			)
		:effect
			(and
				...
				(not (atloc pvan2 mendon_pond))
				(not (atloc pu2 mendon_pond))
				(l2)
				(not (l1))
			)
	)
	(:action p_2Navegate_vehicle
		:parameters ()
		:precondition 
			(and
				(atloc dtruck1 rochester_general)
				(atloc tdriver1 rochester_general)
				(can_drive tdriver1 dtruck1)
				(l2)
			)
		:effect
			(and
				(atloc dtruck1 marketplace)
				(atloc tdriver1 marketplace)
				(not (atloc dtruck1 rochester_general))
				(not (atloc tdriver1 rochester_general))
				(l3)
				(not (l2))
			)
	)
	(:action p_3Climb_in
		...
		:effect
			(and
				(in_vehicle tcrew1 dtruck1)
				(not (atloc tcrew1 marketplace))
				(l4)
				(not (l3))
			)
	)
	(:action p_4Navegate_vehicle
		...
		:effect
			(and
				(atloc dtruck1 twelve_corners)
				(atloc tdriver1 twelve_corners)
				(not (atloc dtruck1 marketplace))
				(not (atloc tdriver1 marketplace))
				(l5)
				(not (l4))
			)
	)
	(:action p_5Climb_out
		...
		:effect
			(and
				(atloc tcrew1 twelve_corners)
				(not (in_vehicle tcrew1 dtruck1))
				(l6)
				(not (l5))
			)
	)
	(:action p_6Load
		...
		:effect
			(and
				(in_vehicle gen1 pvan2)
				(not (atloc gen1 twelve_corners))
				(l7)
				(not (l6))
			)
	)
	(:action p_7Navegate_vehicle
		:parameters ()
		:precondition 
			(and
				(atloc pvan2 brighton_high)
				(atloc pu2 brighton_high)
				(can_drive pu2 pvan2)
				(l7)
			)
		:effect
			(and
				(atloc pvan2 texaco1)
				(atloc pu2 texaco1)
				(not (atloc pvan2 brighton_high))
				(not (atloc pu2 brighton_high))
				(l8)
				(not (l7))
			)
	)
	...
	(:action p_11Navegate_vehicle
		...
		:effect
			(and
				(atloc dtruck1 texaco1)
				(atloc tdriver1 texaco1)
				(not (atloc dtruck1 twelve_corners))
				(not (atloc tdriver1 twelve_corners))
				(l12)
				(not (l11))
			)
	)
	(:action p_12Navegate_vehicle
		:parameters ()
		:precondition 
			(and
				(atloc pvan2 texaco1)
	...
	(:action p_13Climb_in
		...
		:effect
			(and
				(in_vehicle tcrew1 pvan2)
				(not (atloc tcrew1 twelve_corners))
				(l14)
				(not (l13))
			)
	)

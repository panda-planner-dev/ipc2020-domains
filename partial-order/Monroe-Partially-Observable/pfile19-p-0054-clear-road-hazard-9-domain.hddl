...
()
	...
	(:action p_1Navegate_vehicle
		...
		:precondition 
			(and
				(atloc pvan1 rochester_general)
				(atloc pu1 rochester_general)
				(can_drive pu1 pvan1)
				(l1)
			)
		:effect
			(and
				(atloc pvan1 airport)
				(atloc pu1 airport)
				(not (atloc pvan1 rochester_general))
				(not (atloc pu1 rochester_general))
				(l2)
				(not (l1))
			)
	)
	(:action p_2Navegate_vehicle
		...
		:precondition 
			(and
				(atloc dtruck1 park_ridge)
				(atloc tdriver1 park_ridge)
				(can_drive tdriver1 dtruck1)
				(l2)
			)
		:effect
			(and
				(atloc dtruck1 mendon_pond)
				(atloc tdriver1 mendon_pond)
				(not (atloc dtruck1 park_ridge))
				(not (atloc tdriver1 park_ridge))
				(l3)
				(not (l2))
			)
	)
	(:action p_3Climb_in
		...
		:effect
			(and
				(in_vehicle ht1 dtruck1)
				(not (atloc ht1 mendon_pond))
				(l4)
				(not (l3))
			)
	)
	(:action p_4Navegate_vehicle
		...
		:effect
			(and
				(atloc dtruck1 airport)
				(atloc tdriver1 airport)
				(not (atloc dtruck1 mendon_pond))
				(not (atloc tdriver1 mendon_pond))
				(l5)
				(not (l4))
			)
	)
	(:action p_5Climb_out
		...
		:effect
			(and
				(atloc ht1 airport)
				(not (in_vehicle ht1 dtruck1))
				(l6)
				(not (l5))
			)
	)
	(:action p_6Place_cones
		:parameters ()
		:precondition 
			(and
				(l6)

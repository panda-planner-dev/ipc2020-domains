...
(:method m_tlt_set_up_shelter
	...
	(:method regular_1
		:parameters (?crew - tree_crew ?tree - tree)
		:task (ccut_tree ?crew ?tree)
		:subtasks (and
		 (task0 (cut_tree ?crew ?tree))
		)
	)
	(:method regular_2
		:parameters (?police - work_crew)
...
()
	...
	(:action p_1Navegate_vehicle
		...
		:precondition 
			(and
				(atloc wtruck1 henrietta_dump)
				(atloc wcrew1 henrietta_dump)
		...
		:effect
			(and
				...
				(not (atloc wtruck1 henrietta_dump))
				(not (atloc wcrew1 henrietta_dump))
				(l2)
				(not (l1))
			)
	)
	(:action p_2Place_cones
		:parameters ()
		:precondition 
			(and
				(l2)
	...
	(:action p_4Navegate_vehicle
		...
		:precondition 
			(and
				(atloc dtruck1 brighton_high)
				(atloc tdriver1 brighton_high)
		...
		:effect
			(and
				...
				(not (atloc dtruck1 brighton_high))
				(not (atloc tdriver1 brighton_high))
				(l5)
				(not (l4))
			)
	)
	(:action p_5Navegate_vehicle
		...
		:effect
			(and
				(atloc amb1 mendon_pond)
				(atloc emt1 mendon_pond)
				(not (atloc amb1 airport))
				(not (atloc emt1 airport))
				(l6)
				(not (l5))
			)
	)

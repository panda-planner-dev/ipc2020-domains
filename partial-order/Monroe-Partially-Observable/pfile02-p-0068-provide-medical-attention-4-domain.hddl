...
()
	...
	(:action p_1Navegate_vehicle
		...
		:precondition 
			(and
				(atloc backhoe1 park_ridge)
				(atloc ccrew1 park_ridge)
				(can_drive ccrew1 backhoe1)
				(l1)
			)
		:effect
			(and
				(atloc backhoe1 twelve_corners)
				(atloc ccrew1 twelve_corners)
				(not (atloc backhoe1 park_ridge))
				(not (atloc ccrew1 park_ridge))
				(l2)
				(not (l1))
			)
	)
	(:action p_2Climb_in
		...
		:precondition 
			(and
				(atloc person_352181 twelve_corners)
				(atloc backhoe1 twelve_corners)
				(fit_in person_352181 backhoe1)
				(l2)
			)
		:effect
			(and
				(in_vehicle person_352181 backhoe1)
				(not (atloc person_352181 twelve_corners))
				(l3)
				(not (l2))
			)
	)
	(:action p_3Navegate_vehicle
		...
		:effect
			(and
				...
				(atloc ccrew1 strong)
				(not (atloc backhoe1 twelve_corners))
				(not (atloc ccrew1 twelve_corners))
				(l4)
				(not (l3))
			)
	)
	(:action p_4Climb_out
		...
		:effect
			(and
				(atloc person_352181 strong)
				(not (in_vehicle person_352181 backhoe1))
				(l5)
				(not (l4))
			)
	)

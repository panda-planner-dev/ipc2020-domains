...
()
	...
	(:action p_1Navegate_vehicle
		...
		:precondition 
			(and
				(atloc van1 pittsford_plaza)
				(atloc pcrew1 pittsford_plaza)
				(can_drive pcrew1 van1)
				(l1)
			)
		:effect
			(and
				(atloc van1 brighton_dump)
				(atloc pcrew1 brighton_dump)
				(not (atloc van1 pittsford_plaza))
				(not (atloc pcrew1 pittsford_plaza))
				(l2)
				(not (l1))
			)
	)

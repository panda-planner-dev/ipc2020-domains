...
()
	...
	(:action p_4Navegate_vehicle
		...
		:precondition 
			(and
				(atloc wtruck1 brighton_dump)
				(atloc wcrew1 brighton_dump)
		...
		:effect
			(and
				...
				(not (atloc wtruck1 brighton_dump))
				(not (atloc wcrew1 brighton_dump))
				(l5)
				(not (l4))
			)
	)
	(:action p_5Load
		...
		:effect
			(and
				(in_vehicle gen1 dtruck1)
				(not (atloc gen1 texaco1))
				(l6)
				(not (l5))
			)
	)
	(:action p_6Navegate_vehicle
		...
		:effect
			(and
				...
				(not (atloc dtruck1 texaco1))
				(not (atloc tdriver1 texaco1))
				(l7)
				(not (l6))
			)
	)

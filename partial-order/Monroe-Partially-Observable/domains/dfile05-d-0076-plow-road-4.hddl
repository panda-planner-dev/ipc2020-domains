...
()
	...
	(:action p_1Navegate_vehicle
		...
		:effect
			(and
				...
				(not (atloc pvan2 henrietta_dump))
				(not (atloc pu2 henrietta_dump))
				(l2)
				(not (l1))
			)
	)
	(:action p_2Climb_in
		...
		:effect
			(and
				(in_vehicle pdriver1 pvan2)
				(not (atloc pdriver1 twelve_corners))
				(l3)
				(not (l2))
			)
	)
	(:action p_3Navegate_vehicle
		...
		:effect
			(and
				(atloc pvan2 airport)
				(atloc pu2 airport)
				(not (atloc pvan2 twelve_corners))
				(not (atloc pu2 twelve_corners))
				(l4)
				(not (l3))
			)
	)
	(:action p_4Climb_out
		...
		:effect
			(and
				(atloc pdriver1 airport)
				(not (in_vehicle pdriver1 pvan2))
				(l5)
				(not (l4))
			)
	)

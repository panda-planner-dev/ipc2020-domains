...
()
	...
	(:action p_2Navegate_vehicle
		...
		:effect
			(and
				(atloc ttruck1 brighton_dump)
				(atloc ttdriver1 brighton_dump)
				(not (atloc ttruck1 mendon_pond))
				(not (atloc ttdriver1 mendon_pond))
				(l3)
				(not (l2))
			)
	)
	(:action p_3Climb_in
		...
		:effect
			(and
				(in_vehicle ht1 ttruck1)
				(not (atloc ht1 brighton_dump))
				(l4)
				(not (l3))
			)
	)

...
(:method m_tlt_set_up_shelter
	...
	(:method prefix_6
		...
		:precondition (and
			(= ?person pcrew1)
			(= ?veh van1)
			(= ?loc rochester_general)
			(= ?vehloc park_ridge)
		)
		:subtasks (and
		 (task0 (p_6Navegate_vehicle))
		)
	)
...
()
	...
	(:action p_1Navegate_vehicle
		...
		:precondition 
			(and
				...
				(atloc pdriver1 brighton_dump)
				(can_drive pdriver1 plow1)
				(l1)
			)
		:effect
			(and
				(atloc plow1 pittsford_plaza)
				(atloc pdriver1 pittsford_plaza)
				(not (atloc plow1 brighton_dump))
				(not (atloc pdriver1 brighton_dump))
				(l2)
				(not (l1))
			)
	)
	(:action p_2Climb_in
		...
		:effect
			(and
				(in_vehicle sleader2 plow1)
				(not (atloc sleader2 pittsford_plaza))
				(l3)
				(not (l2))
			)
	)
	(:action p_3Navegate_vehicle
		...
		:effect
			(and
				(atloc plow1 park_ridge)
				(atloc pdriver1 park_ridge)
				(not (atloc plow1 pittsford_plaza))
				(not (atloc pdriver1 pittsford_plaza))
				(l4)
				(not (l3))
			)
	)
	(:action p_4Climb_out
		...
		:effect
			(and
				(atloc sleader2 park_ridge)
				(not (in_vehicle sleader2 plow1))
				(l5)
				(not (l4))
			)
	)
	(:action p_5Navegate_vehicle
		:parameters ()
		:precondition 
			(and
				(atloc plow1 park_ridge)
		...
		:effect
			(and
				(atloc plow1 pittsford_plaza)
				(atloc pdriver1 pittsford_plaza)
				(not (atloc plow1 park_ridge))
				(not (atloc pdriver1 park_ridge))
				(l6)
				(not (l5))
			)
	)
	(:action p_6Navegate_vehicle
		:parameters ()
		:precondition 
			(and
				(atloc van1 park_ridge)
				(atloc pcrew1 park_ridge)
				(can_drive pcrew1 van1)
				(l6)
			)
		:effect
			(and
				(atloc van1 rochester_general)
				(atloc pcrew1 rochester_general)
				(not (atloc van1 park_ridge))
				(not (atloc pcrew1 park_ridge))
				(l7)
				(not (l6))
			)
	)

(define (domain someDomain)
	...
	(:types
		...
		wtruck1 - water_truck
		wcrew1 - water_crew
		vehicle_127654 - vehicle
		ttruck1 - tow_truck
		ttdriver1 - tow_truck_driver
...
(:method m_tlt_set_up_shelter
	...
	(:method m_tow_to
		...
		:subtasks (and
		 ...
		 (task1 (chook_to_tow_truck ?ttruck ?veh))
	...
	(:method regular_1
		:parameters (?ttruck - tow_truck ?veh - vehicle)
		:task (chook_to_tow_truck ?ttruck ?veh)
		:subtasks (and
		 (task0 (hook_to_tow_truck ?ttruck ?veh))
		)
	)
	(:method regular_2
		:parameters (?loc - point ?person - adult ?veh - vehicle ?vehloc - point)
	...
	(:method regular_4
		:parameters (?police - work_crew)
		:task (cplace_cones ?police)
		:subtasks (and
		 (task0 (place_cones ?police))
		)
	)
	(:method regular_5
		:parameters (?obj - person ?objloc - point ?veh - vehicle)
...
()
	...
	(:action p_1Climb_in
		...
		:effect
			(and
				(in_vehicle ht2 wtruck1)
				(not (atloc ht2 texaco1))
				(l2)
				(not (l1))
			)
	)
	(:action p_2Navegate_vehicle
		...
		:effect
			(and
				...
				(not (atloc wtruck1 texaco1))
				(not (atloc wcrew1 texaco1))
				(l3)
				(not (l2))
			)
	)
	(:action p_3Climb_out
		...
		:effect
			(and
				(atloc ht2 marketplace)
				(not (in_vehicle ht2 wtruck1))
				(l4)
				(not (l3))
			)
	)
	(:action p_4Place_cones
		:parameters ()
		:precondition 
			(and
				(l4)
	...
	(:action p_5Navegate_vehicle
		...
		:precondition 
			(and
				(atloc ttruck1 park_ridge)
				(atloc ttdriver1 park_ridge)
		...
		:effect
			(and
				...
				(not (atloc ttruck1 park_ridge))
				(not (atloc ttdriver1 park_ridge))
				(l6)
				(not (l5))
			)
	)
	(:action p_6Hook_to_tow_truck
		:parameters ()
		:precondition 
			(and
				(l6)

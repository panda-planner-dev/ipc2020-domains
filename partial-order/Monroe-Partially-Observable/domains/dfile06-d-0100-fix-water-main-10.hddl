...
(:method m_tlt_set_up_shelter
	...
	(:method m_repair_pipe
		...
		:subtasks (and
		 ...
		 (task3 (creplace_pipe ?crew ?from ?to))
	...
	(:method regular_4
		:parameters (?crew - water_crew ?from - point ?to - point)
		:task (creplace_pipe ?crew ?from ?to)
		:subtasks (and
		 (task0 (replace_pipe ?crew ?from ?to))
		)
	)
	(:method regular_5
		:parameters (?loc - point ?person - adult ?veh - vehicle ?vehloc - point)
	...
	(:method prefix_7
		...
		:precondition (and
			(= ?crew wcrew1)
			(= ?from rochester_general)
			(= ?to airport)
		)
		:subtasks (and
		 (task0 (p_7Replace_pipe))
		)
	)
...
()
	...
	(:action p_2Navegate_vehicle
		...
		:effect
			(and
				(atloc wtruck1 rochester_general)
				(atloc wcrew1 rochester_general)
				(not (atloc wtruck1 pittsford_plaza))
				(not (atloc wcrew1 pittsford_plaza))
				(l3)
				(not (l2))
			)
	)
	(:action p_3Navegate_vehicle
		...
		:effect
			(and
				(atloc wtruck1 marketplace)
				(atloc wcrew1 marketplace)
				(not (atloc wtruck1 rochester_general))
				(not (atloc wcrew1 rochester_general))
				(l4)
				(not (l3))
			)
	)
	(:action p_4Climb_in
		...
		:effect
			(and
				(in_vehicle ht1 wtruck1)
				(not (atloc ht1 marketplace))
				(l5)
				(not (l4))
			)
	)
	(:action p_5Navegate_vehicle
		...
		:effect
			(and
				(atloc wtruck1 rochester_general)
				(atloc wcrew1 rochester_general)
				(not (atloc wtruck1 marketplace))
				(not (atloc wcrew1 marketplace))
				(l6)
				(not (l5))
			)
	)
	(:action p_6Climb_out
		...
		:effect
			(and
				(atloc ht1 rochester_general)
				(not (in_vehicle ht1 wtruck1))
				(l7)
				(not (l6))
			)
	)
	(:action p_7Replace_pipe
		:parameters ()
		:precondition 
			(and
				(l7)
